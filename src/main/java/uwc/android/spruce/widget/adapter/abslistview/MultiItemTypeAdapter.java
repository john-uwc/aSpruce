package uwc.android.spruce.widget.adapter.abslistview;
...
import uwc.android.spruce.widget.adapter.abslistview.base.ItemViewDelegate;
import uwc.android.spruce.widget.adapter.abslistview.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends BaseAdapter {
    ...
    public void setDataList(List<T> dataList) {
        if(dataList != null) {
            ...
            Logger.Holder.obtain().log(TAG, "mDataList is null");
        }
    }
    ...
    protected void setListener(final ViewHolder viewHolder, int viewType, final int position) {
        ...
        viewHolder.getConvertView().setOnClickListener(new OnClick() {
            @Override
