...
public class PtrRefreshHeader extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        TypedArray arr = this.getContext().obtainStyledAttributes(attrs, com.chanven.lib.cptr.R.styleable.PtrClassicHeader, 0, 0);
        if (arr != null) {
            this.mRotateAniTime = arr.getInt(com.chanven.lib.cptr.R.styleable.PtrClassicHeader_ptr_rotate_ani_time, this.mRotateAniTime);
        }

        this.buildAnimation();
        View header = LayoutInflater.from(this.getContext()).inflate(R.layout.widget_ptr_refresh_header, this);
        this.mRotateView = header.findViewById(R.id.ptr_header_rotate_view);
        this.mTitleTextView = (TextView) header.findViewById(R.id.ptr_header_rotate_view_header_title);
        this.mLastUpdateTextView = (TextView) header.findViewById(R.id.ptr_header_rotate_view_header_last_update);
        this.mProgressBar = header.findViewById(R.id.ptr_header_rotate_view_progressbar);
        this.resetView();
    }
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            this.mTitleTextView.setText(this.getResources().getString(com.chanven.lib.cptr.R.string.cube_ptr_pull_down_to_refresh));
        } else {
            this.mTitleTextView.setText(this.getResources().getString(com.chanven.lib.cptr.R.string.cube_ptr_pull_down));
        }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        this.mTitleTextView.setVisibility(View.VISIBLE);
        this.mTitleTextView.setText(com.chanven.lib.cptr.R.string.cube_ptr_refreshing);
        this.tryUpdateLastUpdateTime();
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        this.mProgressBar.setVisibility(View.INVISIBLE);
        this.mTitleTextView.setVisibility(View.VISIBLE);
        this.mTitleTextView.setText(this.getResources().getString(com.chanven.lib.cptr.R.string.cube_ptr_refresh_complete));
    ...
    private String getLastUpdateTime() {
        ...
        if (this.mLastUpdateTime == -1L) {
            ...
            if (diffTime < 0L) {
                ...
                sb.append(this.getContext().getString(com.chanven.lib.cptr.R.string.cube_ptr_last_update));
                if (seconds < 60) {
                    sb.append(seconds + this.getContext().getString(com.chanven.lib.cptr.R.string.cube_ptr_seconds_ago));
                } else {
                    ...
                    if (minutes > 60) {
                        ...
                        if (hours > 24) {
                            ...
                            sb.append(hours + this.getContext().getString(com.chanven.lib.cptr.R.string.cube_ptr_hours_ago));
                        }
                    } else {
                        sb.append(minutes + this.getContext().getString(com.chanven.lib.cptr.R.string.cube_ptr_minutes_ago));
                    }
                }
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            this.mTitleTextView.setVisibility(View.VISIBLE);
            this.mTitleTextView.setText(com.chanven.lib.cptr.R.string.cube_ptr_release_to_refresh);
        }
    ...
    private class LastUpdateTimeUpdater implements Runnable {
        ...
        private void start() {
            if (!TextUtils.isEmpty(PtrRefreshHeader.this.mLastUpdateTimeKey)) {
                this.mRunning = true;
                this.run();
            }
        }
        ...
        public void run() {
            PtrRefreshHeader.this.tryUpdateLastUpdateTime();
            if (this.mRunning) {
